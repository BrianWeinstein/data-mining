...
\part \textbf{Validation Set Cross-Validation}\ \ For the same values of $\mu$ used in Part (a), estimations of the the correct classification rate, the false negative rate, and the false positive rate are outlined below.
