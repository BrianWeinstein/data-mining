...
\titledquestion{\href{http://www-bcf.usc.edu/~gareth/ISL/}{James} 6.8.5} \todo{Problem 3}
...
\part Write out the ridge regression optimization problem in this setting.
...
\part Argue that in this setting, the ridge coefficient estimates satisfy $\hat{\beta}_1 = \hat{\beta}_2$.

$$\frac{\partial \mathcal{L}}{\partial \hat{\beta}_1} = -4xy+4x^2\hat{\beta}_1 + 4x^2\hat{\beta}_2 + 2\lambda\hat{\beta}_1 = 0 \quad \quad \Rightarrow \quad \quad\hat{\beta}_1 = \frac{4xy-4x^2\hat{\beta}_2}{4x^2+2\lambda}  $$

and

$$\frac{\partial \mathcal{L}}{\partial \hat{\beta}_2} = -4xy+4x^2\hat{\beta}_1 + 4x^2\hat{\beta}_2 + 2\lambda\hat{\beta}_2 = 0 \quad \quad \Rightarrow \quad \quad\hat{\beta}_2 = \frac{4xy-4x^2\hat{\beta}_1}{4x^2+2\lambda}  .$$


Equating $\frac{\partial \mathcal{L}}{\partial \hat{\beta}_1} = \frac{\partial \mathcal{L}}{\partial \hat{\beta}_2}$ (since both $=0$) and canceling out terms yields:
...
\part Write out the lasso optimization problem in this setting.

\part Argue that in this setting, the lasso coefficients βˆ1 and βˆ2 are not unique—in other words, there are many possible solutions to the optimization problem in (c). Describe these solutions.
...
\titledquestion{\href{http://www-bcf.usc.edu/~gareth/ISL/}{James} 10.7.1} \todo{Problem 9} 
